...
# Load environment variables from a .env file at the repo root (e.g.
# GROQ_API_KEY for the free tier) regardless of how the server is launched.
# This must run before any os.environ reads below.
try:
